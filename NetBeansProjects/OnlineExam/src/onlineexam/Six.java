...
static double s;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Software project manager is engaged with software management activities. He is responsible for ______ .");

        jRadioButton1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton1.setText("Project planning");

        jRadioButton2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton2.setText("Monitoring the progress");
        ...
        jRadioButton3.setText("Communication among stakeholders");

        jRadioButton4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton4.setText("All mentioned above");
