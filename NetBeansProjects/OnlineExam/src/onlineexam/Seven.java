...
static double se;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Which tool consist of programming environments like IDE, in-built modules library and simulation tools?");

        jRadioButton1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton1.setText("Web development tools");

        jRadioButton2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton2.setText("Prototyping tools");
        ...
        jRadioButton3.setText("Programming tools ");

        jRadioButton4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jRadioButton4.setText("Design tools");
